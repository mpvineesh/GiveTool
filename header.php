			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Organization Details (+)</span></a>
							<ul>
								<li><a class="submenu" href="submenu.html"><i class="icon-plus-sign"></i><span class="hidden-tablet"> Add New</span></a></li>
								<li><a class="submenu" href="submenu2.html"><i class="icon-list"></i><span class="hidden-tablet"> View All</span></a></li>
							</ul>	
						</li>						
						<li><a href="index.html"><i class="icon-tasks"></i><span class="hidden-tablet"> Organization Mgmnt</span></a></li>	
						<li><a href="index.html"><i class="icon-tasks"></i><span class="hidden-tablet"> User Mgmnt</span></a></li>	
						<li><a href="login.html"><i class="icon-lock"></i><span class="hidden-tablet"> Logout</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
